# Required packages:
# pip install fastapi uvicorn python-dotenv pymongo "passlib[bcrypt]" "python-jose[cryptography]" email_validator pydantic Flask Flask-Cors Flask-HTTPAuth psycopg2 werkzeug "PyMongo[srv]" PyJWT
